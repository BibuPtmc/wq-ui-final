        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-auto">
            ...
            <Nav.Link
              ...
              to="/registerCat"
              style={
                location.pathname === "/registerCat"
                  ? activeLinkStyle
                  : linkStyle
              }
            >
              <FaExclamationTriangle className="me-1" />{" "}
              {t("navbar.report", "Signaler")}
            </Nav.Link>
            ...
            <Nav.Link
              ...
              to="/lostCats"
              style={
                location.pathname === "/lostCats" ? activeLinkStyle : linkStyle
              }
            >
            ...
            <Nav.Link
              ...
              to="/foundCats"
              style={
                location.pathname === "/foundCats" ? activeLinkStyle : linkStyle
              }
            >
            ...
            <Nav.Link
              ...
              to="/gps-collars"
              style={
                location.pathname === "/gps-collars"
                  ? activeLinkStyle
                  : linkStyle
              }
            >
              <FaTag className="me-1" />{" "}
              {t("navbar.gpsCollars", "Colliers GPS")}
            </Nav.Link>
          </Nav>
              ...
              <>
                ...
                <Dropdown align="end">
                  ...
                  >
                    ...
                    {userData
                      ? `${t("navbar.hello", "Bonjour")} ${userData.firstName}`
                      : t("navbar.hello", "Bonjour")}
                  </Dropdown.Toggle>
