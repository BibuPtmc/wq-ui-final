...
const CatFilters = ({ type = "lost" }) => {
  ...
  const eyeColorSelectOptions = [
    {
      value: "",
      label: t("filters.allEyeColors", "Toutes les couleurs d'yeux"),
    },
      ...
      <Card.Body>
        ...
        <Row>
          ...
          <Col md={4} className="mb-3">
            <Form.Group>
              ...
              <Select
                ...
                value={
                  breedSelectOptions.find(
                    (option) => option.value === filters.breed
                  ) || breedSelectOptions[0]
                }
            ...
            <Form.Group>
              ...
              <Select
                ...
                value={
                  ...
                  ) || colorSelectOptions[0]
                }
                onChange={(selectedOption) =>
                  handleFilterChange("color", selectedOption.value)
                }
                isSearchable
          ...
          <Col md={4} className="mb-3">
            <Form.Group>
              <Form.Label>
                {t("filters.eyeColor", "Couleur des yeux")}
              </Form.Label>
              <Select
                options={eyeColorSelectOptions}
                value={
                  eyeColorSelectOptions.find(
                    (option) => option.value === filters.eyeColor
                  ) || eyeColorSelectOptions[0]
                }
                onChange={(selectedOption) =>
                  handleFilterChange("eyeColor", selectedOption.value)
                }
                isSearchable
                placeholder={t(
                  "filters.selectEyeColor",
                  "Toutes les couleurs d'yeux"
                )}
                className="mb-3"
              />
            </Form.Group>
        ...
        <Row>
          ...
          <Col md={6} className="mb-3">
            <Form.Group>
              <Form.Label>
                {t("filters.currentLocation", "Position actuelle")}
              </Form.Label>
              <div className="d-flex">
                <Button
                  variant={
                    filters.location.latitude ? "success" : "outline-primary"
                  }
              ...
              {filters.location.address && (
                <small className="text-muted d-block mt-1">
                  {filters.location.address}, {filters.location.postalCode}{" "}
        ...
        {(filters.location.latitude || filters.postalCode) && (
          <Row>
            <Col md={12}>
              <Form.Group>
                <Form.Label>
                  {t("filters.searchRadius", "Rayon de recherche")}:{" "}
