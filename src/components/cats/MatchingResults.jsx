        ...
        {matches.length > 0 ? (
                  ...
                  <Card className="h-100 shadow-sm">
                    ...
                    <Card.Body>
                      ...
                      <Row className="text-center mb-3">
                        <Col
                          sm={6}
                          key={`color-${match.matchedCat.catStatusId}`}
                        >
                          <div
                          ...
                          <div className="text-muted small mt-2">
                            {t("matching.color", "Couleur")}
                          </div>
                        </Col>
                        <Col
                          sm={6}
                          key={`breed-${match.matchedCat.catStatusId}`}
                        >
                          <div
                            style={{ width: 60, height: 60, margin: "auto" }}
                          >
                      ...
                      <Row className="text-center mb-3">
                        <Col
                          sm={6}
                          key={`distance-${match.matchedCat.catStatusId}`}
                        >
                          <div
                            style={{ width: 60, height: 60, margin: "auto" }}
                          >
                          ...
                          <div className="text-muted small mt-2">
                            {t("matching.distance", "Distance")}
                          </div>
                        </Col>
                        <Col
                          sm={6}
                          key={`image-${match.matchedCat.catStatusId}`}
                        >
                          <div
                            style={{ width: 60, height: 60, margin: "auto" }}
                          >
                            <CircularProgressbar
                              value={
                                Math.round(match.imageSimilarityScore * 100) ||
                                0
                              }
                              text={`${
                                Math.round(match.imageSimilarityScore * 100) ||
          ...
          <div className="text-center py-4">
            ...
            <p className="text-muted">
              Nous n'avons pas trouvé de chats correspondant aux critères de
              recherche.
            </p>
          </div>
        )}
