            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Col md={6}>
                  <Card className="mb-4">
                    <Card.Header className="bg-light">
                      <h5 className="mb-0">
                        {t("cat.mainInfo", "Informations principales")}
                      </h5>
                    </Card.Header>
                    <Card.Body>
                    ...
                    <Card.Body>
                      ...
                      <Row>
                        ...
                        <Col sm={6}>
                          <Form.Group className="mb-3">
                            <Form.Label>
                              {t("cat.reportDate", "Date de signalement")}*
                            </Form.Label>
                            <Form.Control
                              type="date"
                              name="reportDate"
                ...
                <Col md={6}>
                  <Card className="mb-4">
                    ...
                    <Card.Body>
                      ...
                      <Form.Group className="mb-3">
                        <Form.Label>
                          {t("cat.eyeColor", "Couleur des yeux")}
                        </Form.Label>
                        <Form.Select
                          name="eyeColor"
                        ...
                        >
                          <option value="">
                            {t(
                              "cat.selectEyeColor",
                              "-- Sélectionnez la couleur des yeux --"
                            )}
                          </option>
                          {enums &&
                      ...
                      <Form.Group className="mb-3">
                        <Form.Label>
                          {t("cat.furType", "Type de fourrure")}
                        </Form.Label>
                        <Form.Select
                          name="furType"
                        ...
                        >
                          <option value="">
                            {t(
                              "cat.selectFurType",
                              "-- Sélectionnez le type de fourrure --"
                            )}
                          </option>
                          {enums &&
                        ...
                        {enumsError && (
                          <div className="text-danger">
                            Erreur lors du chargement des types de fourrure
                          </div>
                        )}
                      </Form.Group>
                      ...
                      <Form.Group className="mb-3">
                        <Form.Label>
                          {t("cat.chipNumber", "Numéro de puce")}
                        </Form.Label>
                        <Form.Control
                          type="text"
                          name="chipNumber"
                          ...
                          placeholder={t(
                            "cat.enterChipNumber",
                            "Entrez le numéro de puce"
                          )}
                        />
                      </Form.Group>
                      <Form.Group className="mb-3">
                        <Form.Label>
                          {t("cat.vaccinated", "Vacciné")}
                        </Form.Label>
                        <Form.Select
                          name="vaccinated"
                          value={
                        ...
                        >
                          <option value="">
                            {t("cat.notSpecified", "Non spécifié")}
                          </option>
                  ...
                  <Card className="mb-4">
                    ...
                    <Card.Body>
                      <p className="text-muted">
                        {t(
                          "cat.imageHint",
                          "Ajoutez une photo du chat pour faciliter son identification."
                        )}
                      </p>
                      <Form.Group className="mb-3">
                        <ImageUploader
                      ...
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          placeholder={t(
                            "cat.descriptionPlaceholder",
                            "Entrez une description du chat (signes distinctifs, comportement, etc.)"
                          )}
                        />
                      </Form.Group>
                    </Card.Body>
              ...
              <Card className="mb-4">
                <Card.Header className="bg-light d-flex align-items-center">
                  ...
                  <h5 className="mb-0">
                    {t("cat.location", "Localisation du chat")}
                  </h5>
                </Card.Header>
                <Card.Body>
                  {formData.statusCat === "OWN" ? (
                    <>
                      <p className="text-muted mb-2">
                        {t(
                          "cat.locationUserOnly",
                          "L'adresse de votre profil sera utilisée comme localisation du chat."
                        )}
                      </p>
                      <div className="border rounded bg-light p-3">
                        ...
                        <br />
                        <strong>{t("cat.city", "Ville")} :</strong>{" "}
                        {formData.location.city || "-"}
                        <br />
                        <strong>
                          {t("cat.postalCode", "Code postal")} :
                        </strong>{" "}
                        {formData.location.postalCode || "-"}
                        <br />
                        <strong>{t("cat.latitude", "Latitude")} :</strong>{" "}
                        {formData.location.latitude || "-"}
                        <br />
                        <strong>
                          {t("cat.longitude", "Longitude")} :
                        </strong>{" "}
                    ...
                    <>
                      <p className="text-muted">
                        {t(
                          "cat.locationHint",
                          "Indiquez l'endroit où le chat a été vu pour la dernière fois."
                        )}
                      </p>
                      <Row>
                        <Col xs={12}>
              ...
              <div className="text-center mt-4">
                <p className="text-muted mb-4">
                  * {t("common.required", "Champs obligatoires")}
                </p>
                <Button
                  type="submit"
                  variant="primary"
                  ...
                  title={
                    isUploading
                      ? t(
                          "cat.waitForImages",
                          "Veuillez attendre que les images soient chargées"
                        )
                      : ""
                  }
                >
