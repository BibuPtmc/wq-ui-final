...
export const CatLinkResponse = ({ requestId, onSuccess, onCancel }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>
        {t("catLinkResponder.title", "Répondre à la demande de liaison")}
      </DialogTitle>
      <DialogContent>
        <Box sx={{ mt: 2 }}>
          {error && (
          ...
          <TextField
            label={t(
              "catLinkResponder.commentLabel",
              "Commentaire (optionnel)"
            )}
            placeholder={t(
              "catLinkResponder.commentPlaceholder",
      ...
      <DialogActions>
        ...
        >
          {loading ? (
            ...
            t("catLinkResponder.accept", "Accepter")
          )}
        </Button>
      </DialogActions>
    </Dialog>
...
export const PendingLinkRequests = () => {
  const { fetchPendingRequests, pendingRequests, loading, error } =
    useCatLink();
                ...
                >
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Paper variant="outlined" sx={{ p: 1 }}>
                      ...
                      <Typography variant="body2">
                        <strong>ID:</strong>{" "}
                        {request.foundCatStatus.catStatusId}
                      </Typography>
                    </Paper>
                  </Box>
                </Box>
