  ...
  const getCurrentPosition = useCallback(() => {
    ...
    return new Promise((resolve, reject) => {
      if (!navigator.geolocation) {
        const error = new Error("La géolocalisation n'est pas prise en charge par votre navigateur");
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          if (error.code === 1) errorMessage = "Permission de géolocalisation refusée";
