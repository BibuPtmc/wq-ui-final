...
import {
  PendingLinkRequests,
  SentLinkRequests,
} from "../components/cats/CatLinkResponder";
      ...
      <Container maxWidth="md" sx={{ mt: 4 }}>
        <Paper sx={{ p: 3, textAlign: "center" }}>
          <Typography variant="h5" gutterBottom>
            {t(
              "catLink.authRequired",
              "Vous devez être connecté pour accéder à cette page."
            )}
          </Typography>
          <Typography variant="body1">
            {t(
              "catLink.authRequiredText",
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, mb: 4 }}>
      ...
      <Typography variant="body1" paragraph>
        {t(
          "catLink.intro",
          "Cette page vous permet de gérer les demandes de liaison entre chats perdus et trouvés. Vous pouvez voir les demandes que vous avez envoyées et répondre aux demandes que vous avez reçues."
        )}
      </Typography>
      ...
      <Paper sx={{ width: "100%", mt: 3 }}>
        ...
        <TabPanel value={tabValue} index={0}>
          <Typography variant="body1" paragraph>
            {t(
              "catLink.receivedDesc",
              "Voici les demandes de liaison en attente de votre réponse. Ces demandes ont été envoyées par des utilisateurs qui pensent que leur chat perdu correspond à un chat que vous avez signalé comme trouvé."
            )}
          </Typography>
          <PendingLinkRequests />
        </TabPanel>
