    ...
    <div>
      ...
      <Container className="mt-5">
        ...
        <p>
          {t(
            "home.valuesIntro",
            "Chez Whisker Quest, nous sommes guidés par un ensemble de valeurs qui nous inspirent dans tout ce que nous faisons. Voici quelques-unes de nos valeurs principales :"
          )}
        </p>
        <ul>
      ...
      <Container className="mt-5">
        <h2>
          {t("home.promoTitle", "Promotion de Notre Prochaine Application")}
        </h2>
        <p>
          {t(
            "home.promoText",
            "Nous sommes ravis de vous annoncer le lancement prochain de notre toute nouvelle application mobile ! Restez à l'écoute pour plus d'informations sur les fonctionnalités et la date de sortie."
          )}
        </p>
        {/* Ajout de la vidéo YouTube ici */}
        <div
          className="ratio ratio-16x9 mb-4"
          style={{ maxWidth: "800px", margin: "0 auto" }}
        >
          <iframe
            src="https://www.youtube.com/embed/ajuWz5EX-3o?modestbranding=1&rel=0"
            title="Promotion de l'application Whisker Quest - Vincent Chauvaux"
            allowFullScreen
        ...
        <Button
          variant="success"
          href="https://whisker.netlify.app"
          className="mt-3"
          target="_blank"
